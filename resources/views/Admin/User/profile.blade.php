                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> 
                                    <img src="{{asset('upload/Admin/user/avartar/'.Auth::user()->avatar)}}" class="rounded-circle" width="150" />
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="{{route('Admin.update')}}" method='Post' enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" class="form-control form-control-line" name="email" value="{{Auth::user()->email}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                   ...
                                   <?php //dd($Country); ?>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <!-- <input type="text" class="form-control form-control-line" name="id_country" value="{{Auth::user()->id_country}}"> -->
